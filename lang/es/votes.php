...
return [
    ...
    'notifications' => [
        ...
        'opened_for_participant' => 'Votación abierta: :title',
    ],

    'hints' => [
        'add_options_after_save' => 'Después de crear, use Opciones de voto en el listado para añadir al menos 2 opciones antes de abrir la votación.',
    ],
