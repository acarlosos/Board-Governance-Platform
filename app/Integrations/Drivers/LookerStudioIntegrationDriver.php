...
final class LookerStudioIntegrationDriver implements IntegrationDriverInterface
{
    use ValidatesRequiredConfig;

    public function test(Integration $integration): IntegrationTestResult
    {
        return $this->validateRequired($integration, IntegrationProvider::LookerStudio);
    }
}
