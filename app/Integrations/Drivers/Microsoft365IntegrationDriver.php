...
final class Microsoft365IntegrationDriver implements IntegrationDriverInterface
{
    use ValidatesRequiredConfig;

    public function test(Integration $integration): IntegrationTestResult
    {
        return $this->validateRequired($integration, IntegrationProvider::Microsoft365);
    }
}
