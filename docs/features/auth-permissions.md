...
- **`SEED_ADMIN_EMAIL` e `SEED_SUPER_ADMIN_EMAIL` têm de ser diferentes** — se forem iguais, o `SuperAdminSeeder` (último no `DatabaseSeeder`) sobrescreve o registo do tenant admin e fica só o ROOT.
